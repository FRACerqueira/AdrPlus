...
- **Version**: `1.0.0-rc1` (published as a GitHub tag; the project is in release candidate — avoid breaking changes unless critical for the 1.0.0 release; if one is truly unavoidable, still don't add compatibility aliases/shims for renames).
