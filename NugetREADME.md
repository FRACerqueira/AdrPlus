...
> 🤖 **New:** manage your ADRs conversationally with the [**AdrPlus AI Assistant Plugin**](https://github.com/FRACerqueira/AdrPlus-IA-Plugin) — let Claude Code or GitHub Copilot create, approve, audit, and index ADRs for you.
