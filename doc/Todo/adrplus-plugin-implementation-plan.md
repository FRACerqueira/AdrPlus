...
- Everything remaining in the spec's §14 Roadmap: Plugin SDK/template + test harness. (The zip-based `adrplus plugins --install`/`--uninstall` distribution flow originally listed here shipped as D35/Phase 13, then D36/Phase 14 — no longer out of scope.)
